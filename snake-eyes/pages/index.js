    ...
    <body>
      <div className={styles.homePage}>
        <div className={styles.mainHomePage} id="mainHomePage">
          ...
          <div className={styles.aboutUs}>
            <div className={styles.aboutText}>
              ...
              <p>
                ...
                slithering onto the Solana block chain. Each boasting an array
                of different styles, eccentricity, colors, and attitudes.{" "}
                <br></br>
          ...
          <h1 className={styles.headerText} data-aos="fade-in">
            Meet the team
          </h1>
          ...
          <div className={styles.roadMapContainer}>
            <h1 id="roadmap" className={styles.headerText}>
              roadmap
            </h1>
            <img className={styles.roadmap} src="/roadmap.jpg"></img>
          </div>
          <div className={styles.FAQ}>
            <h1 id="FAQ" className={styles.headerText}>
              FAQ
            </h1>
            <div className={styles.accordionContainer}>
              <Accordion title="Supply" content="5555 Unique Patterns!" />
              <Accordion title="Date" content="To Be Determined..." />
              <Accordion title="Price" content="2 sol" />
              <Accordion title="Blockchain" content="Solana" />
            </div>
          </div>
        </div>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.enterModal}>
              ...
              <div className={styles.logoGrid}>
                <img className={styles.logo} src="/headerlogo.png" />
              </div>
              <a className={styles.gridBtn}>
                <button
                  onClick={() => {
                    ...
                    document.getElementById("mainHomePage").style.filter =
                      "none";
                  }}
